...
Vanilla/fully connected GAN for MNIST dataset
...
if __name__ == '__main__':
    ...
    with tf.variable_scope('discriminator'):
        ...
        D_W1 = tf.get_variable('D_W1', initializer=xavier_init([784, 128]))
    ...
    with tf.variable_scope('generator'):
        ...
        G_W1 = tf.get_variable('G_W1', initializer=xavier_init([100, 128]))
        G_b1 = tf.get_variable('G_b1', initializer=tf.zeros(shape=[128]))

        G_W2 = tf.get_variable('G_W2', initializer=xavier_init([128, 784]))
        G_b2 = tf.get_variable('G_b2', initializer=tf.zeros(shape=[784]))
